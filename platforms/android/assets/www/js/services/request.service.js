...
var RequestService = (function () {
    ...
    RequestService.prototype.getServices = function () {
        return this.http
            .get('api/services')
            .toPromise()
            .then(function (response) { return response.json(); })
    ...
    RequestService.prototype.getSchools = function () {
        return this.http
            .get('api/schools')
            .toPromise()
            .then(function (response) { return response.json(); })
    ...
    RequestService.prototype.getRoles = function () {
        return this.http
            .get('api/roles')
            .toPromise()
            .then(function (response) { return response.json(); })
    ...
    RequestService.prototype.saveRequest = function (request) {
